"""input csv files : need headers 'Colorcode','aantal' en 'beeld'"""
...
import source.summary as samenvatting
...
while True:
    ...
    while True:
        ...
        if event in ('Exit', None):
            ...
            # maak een arglist?
            samenvatting.summary_file(result, ordernummer,
                                     mes,
                                     row,
                                     totaal,
                                     ongeveer_per_baan,
            ...
            if check_1 is not True:
                ...
                csv_builder.end_result_csv(result_map, mes)
                ...
                # samenvatting.html_sum_form_writer(ordernummer,**sum_values)
                #maakt van de ingevoerde values een html file
                ...
                samenvatting.verticale_summary(summary, mes, result, ordernummer, aantal_vdps)
